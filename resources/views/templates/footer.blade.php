	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			<div class="symbol symbol-100 mr-5">
				<div class="symbol-label" style="background-image:url('{{asset('public/user.jpg')}}')"></div>
			...
			<div class="d-flex flex-column">
				...
				<div class="navi mt-2">
					...
					<a href="{{ url('logout') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign
						Out</a>
				</div>
			</div>
		</div>
...
<script src="{{asset('public/new_theme/assets/plugins/custom/datatables/datatables.bundle.js')}}"></script>
<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
<script src="{{asset('public/new_theme/assets/js/pages/crud/datatables/basic/scrollable.js')}}"></script>
...
<script>
	...
	$('._change_active').on('click', function () {//_approved_active
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				$.ajax({
					url: '{{url("/")}}/{{ isset($OtherRoute) ? $OtherRoute : "" }}/updateactive',
					type: 'POST',
	...
	$('._approved_continue').on('click', function () {
		var id = $(this).attr('data-id');
		var token = $(this).attr('data-token');
		let baseUrl = '{{ url("/change_request2/approved_continue") }}';
	...
	$('.dis_approved_continue').on('click', function () {
		var id = $(this).attr('data-id');
		var token = $(this).attr('data-token');
		let baseUrl = '{{ url("/change_request2/approved_continue") }}';
...
<script>
	$(document).ready(function () {
		$('#custom_field_group_id').select2({
			placeholder: "Select Group",
			allowClear: true
		});
		$('#custom_field_wf_type_id').select2({
			placeholder: "Select Work Flow Type",
			allowClear: true
		});
		$('#custom_field_status_id').select2({
			placeholder: "Select Status",
			allowClear: true
		});
	});
