<div class="d-flex flex-column flex-root">
                ...
                <div class="container d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="d-flex align-items-stretch mr-3">
                        ...
                        <div class="header-logo">
                            <a href="{{ url('/') }}">
                                <img alt="Logo" src="{{asset('public/logo-we.jpg')}}" class="logo-default max-h-40px"/>
                        ...
                        <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                                            ...
                                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                                <ul class="menu-subnav">
                                                                        ...
                                                                        <li class="menu-item menu-item-submenu menu-item-rel"
                                                                            ...
                                                                            <a href="{{ route('custom-fields.index') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span class="menu-text">Add Or Update Custom Fields</span>
                                                                            </a>
                                                                        </li>
                                                                    @endcan
                                                                        ...
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                            <a href="{{ route('custom.fields.create') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span
                                                                                    class="menu-text">Create CR CF</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                        ...
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                            <a href="{{ route('custom.fields.special') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span
                                                                                    class="menu-text">Create CR special CF</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                            <a href="{{ route('custom.fields.view') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span
                                                                                    class="menu-text">View CR CF</span>
                                                                            </a>
                                                                        </li>
                                                                        ...
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                            <a href="{{ route('custom.fields.special.view') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span
                                                                                    class="menu-text">View CR Special CF</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                            <a href="{{ route('custom.fields.viewupdate') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span
                                                                                    class="menu-text">Update CR CF</span>
                                                                            </a>
                                                                        </li>
                                                                        ...
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                            <a href="{{ route('custom.fields.special.viewupdate') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span
                                                                                    class="menu-text">Update CR Special CF</span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                            <a href="{{ route('custom.fields.special.viewsearch') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span
                                                                                    class="menu-text"> Search Special CF</span>
                                                                            </a>
                                                                        </li>
                                                                        ...
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                            <a href="{{ route('custom.fields.createCF') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span
                                                                                    class="menu-text"> Search Result CF  </span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                            <a href="{{ route('custom.fields.special.viewresult') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span class="menu-text">  Search Result Special CF </span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                            <a href="{{ route('custom.fields.special.viewadvanced') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span
                                                                                    class="menu-text"> Advanced Search CF </span>
                                                                            </a>
                                                                        </li>
                                                                        <li class="menu-item" aria-haspopup="true">
                                                    ...
                                                    @can('List Workflows')
                                                        <li class="menu-item menu-item-submenu menu-item-rel"
                                                            data-menu-toggle="click" aria-haspopup="true">
                                                            <a href="{{ url('NewWorkFlowController') }}"
                                                               class="menu-link">
															<span class="svg-icon menu-icon">
																				<!--begin::Svg Icon | path:assets/media/svg/icons/General/Shield-check.svg-->
																				<svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <span class="svg-icon menu-icon">
                                                        <img
                                                            src="{{ asset('public/new_theme/assets/media/group.png') }}"
                                                                        ...
                                                                        <li class="menu-item" aria-haspopup="true">
                                                                            <a href="{{ url('division_manager') }}"
                                                                               class="menu-link">
                                                                                ...
                                                                                <span
                                                                                    class="menu-text">Division Manager</span>
                                                                            </a>
                                                                        </li>
                                                                    @endcan
                                                                    @can('List Director')
                            ...
                            @endcan
                            @canany(['Final Confirmation', 'Edit Testable Form', 'Admin Add Attachments and Feedback', 'shifting CRS', 'List Permissions'])
                                <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                                    aria-haspopup="true">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                        <ul class="menu-subnav">
                                            ...
                                            @can('shifting CRS')
                                                <li class="menu-item menu-item-submenu menu-item-rel"
                                                    data-menu-toggle="click" aria-haspopup="true">
                                                    <a href="{{ url('/change-requests/reorder/home') }}"
                                                       class="menu-link">
														<span class="svg-icon menu-icon">
																	<!--begin::Svg Icon | path:assets/media/svg/icons/General/Shield-check.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                        <ul class="menu-subnav">
                                            @can('Show My CRs')
                                                <li class="menu-item menu-item-submenu menu-item-rel"
                                                    data-menu-toggle="click" aria-haspopup="true">
                                                    <a href="{{ url('change_request/listcrsbyuser') }}"
                                                       class="menu-link">
																		<span class="svg-icon menu-icon">
																				<!--begin::Svg Icon | path:assets/media/svg/icons/General/Shield-check.svg-->
																				<svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <li class="menu-item menu-item-submenu menu-item-rel"
                                                data-menu-toggle="click" aria-haspopup="true">
                                                <a href="{{ url('change_request2/dvision_manager_cr') }}"
                                                   class="menu-link">
																		<span class="svg-icon menu-icon">
																				<!--begin::Svg Icon | path:assets/media/svg/icons/General/Shield-check.svg-->
																				<svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            @can('Show cr pending cap')
                                                <li class="menu-item menu-item-submenu menu-item-rel"
                                                    data-menu-toggle="click" aria-haspopup="true">
                                                    <a href="{{ url('change_request2/cr_pending_cap') }}"
                                                       class="menu-link">
																		<span class="svg-icon menu-icon">
																				<!--begin::Svg Icon | path:assets/media/svg/icons/General/Shield-check.svg-->
																				<svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            @can('Release To CRs')
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="{{ url('/releases/home') }}" class="menu-link">
                                                        ...
                                                        <span class="menu-text">Release to CRS</span>
                                                    </a>
                                                </li>
                                            @endcan
                                        </ul>
                            ...
                            <li class="menu-item menu-item-submenu menu-item-rel position-relative"
                                data-menu-toggle="click" aria-haspopup="true">

                                <div id="app">

                                    <sample-component :interval="{{ env('DIGITAL_SOLUTIONS_INTERVAL') }}"
                                                      base-url="{{ env('VUE_APP_BASE_URL') }}"
                                                      ref="sampleComponent"></sample-component>
	...
	@if(session()->has('current_group_name'))
                                            ...
                                            @foreach ($userGroups as $group)
                                                @if(Session::has('current_group') && Session::get('current_group') == $group->group->id)
                                                    <a class="dropdown-item {{ Session::has('current_group') && Session::get('current_group') == $group->group->id ? 'active' : '' }}"
                                                       href="{{route('change_request.asd',['group'=>$group->group->id])}}">
                                                        @else
        ...
        @endphp
          <span class="symbol-label text-white font-size-h5 font-weight-bold bg-white-o-30">{{$first_letters}}</span>
