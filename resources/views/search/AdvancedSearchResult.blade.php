...
@csrf
<button type="submit" class="btn btn-light-primary font-weight-bolder">											<span class="svg-icon svg-icon-md">
...
@endif
                                        ...
                                        <!-- <a href="{{ url('/change-request/showform/' . $item['id']) }}"> 
                                            <a  href="">
                                            <img src="{{ asset('media/svg/icons/Communication/eye.svg') }}" alt="View">
                                        </a>-->
