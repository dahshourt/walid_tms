...
<div class="card-body">
    ...
    <div class="form-group">
        <h6>Role Name <span class="text-danger">*</span></h6>
        <input type="text" class="form-control form-control-lg" placeholder="Name" name="role"
                    ...
                    <div class="col-md-4 mb-2">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="permission_{{ $module_permissions->id }}">
                                <strong>{{ ucfirst($module_permissions->module) . ':' }}</strong> (hint
                                : {{ $module_permissions->name }} )
                            </label>
                        </div>
                    </div>
                </div>
