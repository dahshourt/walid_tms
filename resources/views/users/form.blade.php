<div class="card-body">
    ...
    @endif
    <input type="hidden" class="form-control form-control-lg" placeholder="Name" name="user_id"
           value="{{ isset($row) ? $row->id : '' }}"/>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control form-control-lg" placeholder="UserName" name="user_name"
               value="{{ isset($row) ? $row->user_name : old('user_name') }}" autocomplete="off"/>
    ...
    <div class="form-group">
        ...
        <select class="selectpicker form-control form-control-lg " id="role_id" name="roles[]" multiple
                title="Select Roles">
...
-->
    ...
    <div class="form-group">
        ...
        <select class="form-control form-control-lg" id="default_group" name="default_group">
            ...
            @foreach($groups as $item)
                <option
                    value="{{ $item->id }}" {{ isset($row) && $row->default_group == $item->id ? "selected" : "" }}> {{ $item->title }} </option>
            @endforeach
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control form-control-lg" id="unit_id" name="unit_id">
            ...
            @foreach($units as $item)
                <option
                    value="{{ $item->id }}" {{ isset($row) && $row->unit_id == $item->id ? "selected" : "" }}> {{ $item->name }} </option>
            @endforeach
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control form-control-lg" id="department_id" name="department_id">
            ...
            @foreach($departments as $item)
                <option
                    value="{{ $item->id }}" {{ isset($row) && $row->department_id == $item->id ? "selected" : "" }}> {{ $item->name }} </option>
            @endforeach
        </select>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Man Power" name="man_power"
        ...
        <div class="checkbox-inline">
            <label class="checkbox">
                ...
                <input type="checkbox" name="active"
                       {{ isset($row) && $row->active == "1" ? "checked" : "" }} value="1"/>
