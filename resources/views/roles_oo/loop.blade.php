...
@foreach ($collection as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can('Show Role')
                                        <a href='{{ url("$route") }}/{{ $item->id }}' class="btn btn-sm btn-clean btn-icon mr-2" title="Show Role Permissions">
