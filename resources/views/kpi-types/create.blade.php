            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('kpi-types.index') }}" class="btn btn-light-primary font-weight-bolder">
                ...
                <!--begin::Form-->
                <form method="POST" action="{{ route('kpi-types.store') }}">
                    @csrf
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" 
                                       ...
                                       placeholder="Enter KPI type name"
                                       value="{{ old('name') }}"
                                       required />
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <span class="form-text text-muted">Toggle to activate/deactivate this KPI type</span>
