<div class="card-body">
    ...
    <div class="form-group form-group-last">
        <div class="form-group">
            <label for="user_type">Group Name <span class="text-danger">*</span></label>
            <input type="text" name="title" class="form-control form-control-lg" place_holder="Enter Group Name..."
        ...
        <div class="form-group">
            <label for="user_type">Description <span class="text-danger">*</span></label>
            <input type="text" name="description" class="form-control form-control-lg"
                   place_holder="Enter Group Description..."
        ...
        <div class="form-group">
            <label for="user_type">Group Power <span class="text-danger">*</span>
                <small class="text-muted">(hours allocated per day)</small>
            </label>
            <input type="text" name="man_power" class="form-control form-control-lg" place_holder="Enter Group Power..."
                   value="{{ isset($row) ? $row->man_power : old('man_power') }}"/>
            {!! $errors->first('man_power', '<span class="form-control-feedback">:message</span>') !!}

        </div>
        <div class="form-group">
            <label for="status_id">Applications:</label>
            <select class="form-control form-control-lg select2" id="status_id" name="application_id[]"
                    multiple="multiple">
        ...
        <div class="form-group">
            ...
            <input type="text" name="head_group_name" class="form-control form-control-lg"
                   place_holder="Enter Head Group Name..."
                   value="{{ isset($row) ? $row->head_group_name : old('head_group_name') }}"/>
        ...
        <div class="form-group">
            ...
            <input type="text" name="head_group_email" class="form-control form-control-lg"
                   place_holder="Enter Head Group Email..."
                   value="{{ isset($row) ? $row->head_group_email : old('head_group_email') }}"/>
        ...
        <div class="form-group">
            ...
            <div class="checkbox-inline">
                <label class="checkbox">
                    ...
                    <input type="checkbox" name="recieve_notification"
                           value="1" {{ isset($row) && $row->recieve_notification == '1' ? "checked" : "" }}>
                    <span></span>Yes</label>
            </div>
        </div>
            ...
            <div class="checkbox-inline">
                <label class="checkbox">
                    ...
                    <input type="checkbox" name="active"
                           value="1" {{ (isset($row) && $row->active == 1) || old('active', 0) == 1 ? "checked" : "" }}>
                    <span></span>Yes</label>
            </div>
        </div>
