            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('kpi-pillars.index') }}" class="btn btn-light-primary font-weight-bolder">
                ...
                <!--begin::Form-->
                <form method="POST" action="{{ route('kpi-pillars.store') }}">
                    @csrf
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" 
                                       ...
                                       placeholder="Enter KPI pillar name"
                                       value="{{ old('name') }}"
                                       required />
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <span class="form-text text-muted">Toggle to activate/deactivate this KPI pillar</span>
