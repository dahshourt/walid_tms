...
@section('content')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title">Manage Custom fields - Search</h3>
                            </div>
                            <!--begin::Form-->
                            <div class="card-body">
                                <form class="form" action="{{ route('custom.fields.store') }}" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="custom_field_group_id" name="group_id" class="form-control select2"
                                            required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function loadCustomFields(group_id) {
                $.ajax({
                    url: '{{ url("customs/field/group/type/selected") }}',
                    method: 'GET',
                    data: {
                        by: "group_id",
                        value: group_id,
