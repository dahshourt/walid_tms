                            ...
                            <div class="card-body">
                                <form class="form" action="{{ route('custom.fields.store') }}" method="post"
                                    ...
                                    <div class="form-group">
                                        <label for="custom_field_wf_type_id">Work Flow Type:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="custom_field_status_id">Statuses:</label>
                                        <select class="form-control select2" id="custom_field_status_id" name="status_id"
                                            onchange="workFlowTypeChange()">
                                            <option value="">Choose...</option>
