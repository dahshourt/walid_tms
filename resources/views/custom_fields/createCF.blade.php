...
@section('content')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title">Search Result CF</h3>
                            </div>
                            <!--begin::Form-->
                            <div class="card-body">
                                <form class="form" action="{{ route('custom.fields.store') }}" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="custom_field_wf_type_id" name="wf_type_id" class="form-control select2"
                                            required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $('#custom_field_wf_type_id').change(function () {
