    ...
    <div class="col-md-6 change-request-form-field">
        ...
        <div class="form-group">
            <div class="checkbox-inline">
                ...
                <input type="checkbox" {{ (isset($item->enable)&&($item->enable!=1)) ? "disabled" : "" }} name="{{ $item->CustomField->name }}"  @if(isset($cr->{$item->CustomField->name}) && $cr->{$item->CustomField->name} == 1) checked @endif
