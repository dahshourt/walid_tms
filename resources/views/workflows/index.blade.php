									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										...
										<div class="card-toolbar">
											...
											@if(isset($collection) && $collection->count() > 0)
												<a href="{{ route('workflow.export') }}" class="btn btn-success font-weight-bolder ml-2">
													<span class="svg-icon svg-icon-md">
											...
											@else
												<span class="btn btn-secondary font-weight-bolder ml-2" style="opacity: 0.6; cursor: not-allowed;" title="No data available to export">
													<span class="svg-icon svg-icon-md">
														<!--begin::Svg Icon | path:assets/media/svg/icons/Files/Download.svg-->
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
