@if($same_time_from)
    ...
    <div class="form-group">
        ...
        <select class="form-control form-control-lg" id="from_previous_status_id" name="from_status_id[]"
            multiple="multiple">
...
@else
    ...
    <div class="form-group">
        ...
        <select class="form-control form-control-lg select2" id="previous_status_id" name="previous_status_id">
            <option value="">Select</option>
            @foreach($statuses as $item)
    ...
    <div class="form-group">
        ...
        <select class="form-control form-control-lg select2" id="from_status_id" name="from_status_id">
            <option value="">Select</option>
            @foreach($statuses as $item)
