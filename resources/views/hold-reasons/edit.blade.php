            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('hold-reasons.index') }}" class="btn btn-light-primary font-weight-bolder">
                ...
                <!--begin::Form-->
                <form method="POST" action="{{ route('hold-reasons.update', $row->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" 
                                       ...
                                       placeholder="Enter hold reason name"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <span class="form-text text-muted">Toggle to activate/deactivate this hold reason</span>
