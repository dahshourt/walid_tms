...
<html lang="en">
	...
	<head><base href="../../../../">
        ...
        <link href="{{asset('public/new_theme/assets/css/pages/login/classic/login-3.css')}}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" style="background-image: url({{asset('public/new_theme/assets/media/bg/bg-10.jpg')}})" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-3 login-signin-on d-flex flex-row-fluid" id="kt_login">
				<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url({{asset('public/new_theme/assets/media/bg/bg-1.jpg')}});">
