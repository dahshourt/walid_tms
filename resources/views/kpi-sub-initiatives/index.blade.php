            ...
            <div class="card">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        @can('Create KPI Sub-Initiatives')
                        <!--begin::Button-->
                        <a href='{{ route("kpi-sub-initiatives.create") }}' class="btn btn-primary font-weight-bolder">
    ...
    $('.status-toggle').on('change', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '{{ route("kpi-sub-initiatives.update-status") }}',
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        id: itemId
