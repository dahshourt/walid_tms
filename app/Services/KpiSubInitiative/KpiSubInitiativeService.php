...
{
    protected $kpiSubInitiativeRepository;

    public function __construct(KpiSubInitiativeRepository $kpiSubInitiativeRepository)
    {
        $this->kpiSubInitiativeRepository = $kpiSubInitiativeRepository;
    }
